...
var placesToVisitCopy = placesToVisit.slice();
bubbleSortForward(placesToVisitCopy);
console.log(placesToVisit);
function bubbleSortReversed(list) {
    var n = list.length;
    for (var i = 0; i < n - 1; i++) {
        for (var j = 0; j < n - i - 1; j++) {
            if (list[j] < list[j + 1]) {
